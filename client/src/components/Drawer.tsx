...
const Drawer = ({ isOpen, onClose, selectedTask }: DrawerProps) => {
  return (
    <div>
      <div
        className={`fixed top-0 right-0 h-full w-75 bg-[#535353] p-6 transition-transform z-50 ${
      ...
      >
        ...
        {selectedTask && (
          <>
            <p className="mt-4 font-bold text-white text-2xl">{selectedTask.description}</p>
